...
def run(path, LSTMLayers, LSTMDims, ReLULayers, ReLUDims, L2, epochs, biDirectional):
...
#                         outFile=outFile, fullRun=False, biDirectional=True)
# run(fullDataPath, LSTMLayersVar[0], LSTMDimsVar[0], ReLuLayersVar[2], ReLuDimsVar[1], L2Var[0], epochsVar[0])
